...
const $ = load_plugins();
const tsFiles: string = "front/javascripts/*.ts";
const sassFiles: string = "front/stylesheets/*.{scss,sass}";
const imgFiles: string = "front/images/*.{jpeg,jpg,png,svg,gif}";
const fontFiles: string = "front/fonts/*.{ttf,otf,wtf}"; 
